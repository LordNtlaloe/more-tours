...
-- AddForeignKey
ALTER TABLE `reserved_dates` ADD CONSTRAINT `reserved_dates_reservationId_fkey` FOREIGN KEY (`reservationId`) REFERENCES `reservations`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
