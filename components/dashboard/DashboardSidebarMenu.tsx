...
export default function DashboardSidebarMenu() {
  return (
    <main className="mx-2 rounded-xl md:block w-72 md:w-14 bg-white text-slate-800 md:hover:w-72 transition-all duration-500">
      <nav className="pt-3 py-2 flex flex-col justify-between h-full">
        <div>
          {dashboardMenu.map((item) => (
            ...
            >
              <div className="flex pl-3 gap-10 hover:bg-slate-100 mx-2 py-2 rounded-[5px] transition-all duration-500">
